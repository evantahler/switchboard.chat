...
class AddTeamMemberForm extends React.Component {
  ...
  async submit (form) {
    ...
    const saveResponse = await TeamMemberRepository.create(data)
    if (saveResponse) {
    ...
    return (
      ...
      >
        ...
        <Form.Group controlId='email'>
          ...
          <Form.Control required type='email' placeholder='member@example.com' value={teamMember.email} onChange={e => update(e)} />
