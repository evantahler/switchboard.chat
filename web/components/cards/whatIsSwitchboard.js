  ...
  return (
    <Card border='info'>
      <Card.Body>
        ...
        <Card.Text>
          <p>Switchboard.chat is a hosted web application which enables teams to communicate with thier remote employees via SMS. Using a shared, hosted SMS number enables:</p>
          <ul>
