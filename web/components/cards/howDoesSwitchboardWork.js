  ...
  return (
    <Card border='info'>
      <Card.Body>
        ...
        <Card.Text>When you create your team, you can choose your phone number's area code, and choose from a selection of available numbers. Please note that this service only works within the United States at this time 🇺🇸 .</Card.Text>
