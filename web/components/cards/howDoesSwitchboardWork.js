  ...
  return (
    <Card border='info'>
      <Card.Body>
        ...
        <Card.Text>When you sign up for Switchboard, you will be creating your team and the first member of that team...you!</Card.Text>
        ...
        <Card.Text>When you create your team, you can choose your phone number's area code, and choose from over thousads of available numbers.  We offer phone nubmers in 90% of US area codes.  <em>Please note that this service only works within the United States at this time 🇺🇸</em>. </Card.Text>
